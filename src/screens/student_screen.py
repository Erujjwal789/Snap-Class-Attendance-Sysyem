   ...
   #            unenroll_student_to_subject(student_id, sid)
     def unenroll_button():
       if st.button(
        ...
        #st.warning("Unenrolled Successfully")
...
def student_screen():
    ...
    photo_source = st.camera_input("Postition your face in the center")
       ...
       with st.spinner('AI is scanning..'):
          ...
          if num_faces == 0:
             ...
             if detected:
                ...
                st.info('face not recognized! you meight be new student!')
    ...
    if show_registration:
       with st.container(border= True):
          ...
          new_name = st.text_input("Enter your name ", placeholder='E.g. uzzwal')
          ...
          try:
             audio_data = st.audio_input('record a short phrase like I am present , my name is uzzwal. ')
          except Exception:
