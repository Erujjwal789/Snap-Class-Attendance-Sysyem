...
def teacher_tab_attendance_records():
  ...
  for r in records:
    ...
    data.append({
      ...
      "Time": datetime.fromisoformat(ts).strftime("%Y-%m-%d %I:%M %p") if ts else "N/A",      "Subject": r['subjects']['name'],
...
def teacher_screen_login():
    ...
    teacher_username= st.text_input("Enter username", placeholder='uzzwal')
...
def teacher_screen_register():  
   ...
   teacher_username= st.text_input("Enter username", placeholder='uzzwal')
   teacher_name = st.text_input("Enter name ", placeholder="uzzwal")
